...
public:
    ...
    void Insert_Value_After_Spacific_Value(int before_value, int new_data)
    {
        ...
        if( a == NULL)
        {
            cout<< before_value <<"value doesn't exist linked list.\n";
            return;
        }
...
int main()
{
    ...
    l.Insert_Value_After_Spacific_Value(20, 50); // 20 er pore 50 insert kora holo.
    l.Travers();
    cout<<"linked list length or size = "<<l.getSize()<<"\n";

    l.Insert_Value_After_Spacific_Value(10, 56); // 10 er pore 56 insert kora holo.
    l.Travers();
    cout<<"linked list length or size = "<<l.getSize()<<"\n";
